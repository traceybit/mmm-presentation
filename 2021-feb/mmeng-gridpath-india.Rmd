...
--
  ...
  * Build scenarios for renewable portfolio obligation targets of 10%, 30%, 50%, and 70%
...
# Cheap coal is co-located with poverty

--
* Coal power plants are concentrated in west-central northern regions of India
```{r coal, echo = FALSE, out.width = '45%', out.extra='style="float:right; padding:5px"'}
...
* As solar and wind get cheaper, the more expensive coal plants in higher income regions will shut down first
...
2. **Will the environmental benefits of high renewable penetration be distributed equitably across India?**
  ...
  Next steps:
    * Assign pollutant factors (for NOx, SOx, PM2.5, etc) to power plants
...
* 10% of electricity is generated from hydropower plants, which also require water 
--

* Power plants have had to shut down in recent years due to water shortages

```{r echo = FALSE, out.width = '45%', out.extra='style="float:left; padding:1px"'}
knitr::include_graphics("img/water-crisis-1.png")
```

```{r echo = FALSE, out.width = '45%', out.extra='style="float:right; padding:1px"'}
